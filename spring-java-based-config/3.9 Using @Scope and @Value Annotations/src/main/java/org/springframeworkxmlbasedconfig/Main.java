...
//                <!--    <bean id="desk" class="org.springframeworkxmlbasedconfig.Desktop"/>-->
        ...
        // Scope And Value
        // When we talked about different scopes. We have Singleton, Prototype. If you want to use them you can mention that with the help of @Scope annotation when we are getting a bean.
        // To mention that we have to use at class level @Scope("prototype"). As of now we are getting the default value for age = 0 we can declare it directly in Laien int age = 28;
        // But sometimes you want to inject this value from some other property files. How will you inject a value? Not the object but the value.
        // In that case we have to use another annotation which is called @Value.
        // But when you use the annotation like @Value, basically you can inject this value from outside the code. Maybe you have a property file in which you have all the values.
        // You can specify the values there, and we have specified those property names here.
    }
}