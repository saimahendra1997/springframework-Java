...
//        System.out.println("Student added successfully in to database...");
        ...
        // we have to make sure that the sequence are matching.if we click on update we can see update returns a integer value.That means the number of rows affected.
